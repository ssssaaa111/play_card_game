export const library = [
  ...
  { id: "starforge-fusion", type: "spell", name: "星魂融合", icon: "融", text: "选择我方场上的赤焰幼龙和疾风术士作为融合素材送入墓地，从手牌或卡组特殊召唤焰岚合星者。", summary: "把指定场上素材送入墓地，融合召唤焰岚合星者。", effect: "fusionSummon", fusion: { result: "flare-gale-archon", materials: ["ember-drake", "gale-mage"] } },
...
export const monsterAssets = {
  ...
  "spark-fragment-token": "assets/monster-wind-mage.png",
