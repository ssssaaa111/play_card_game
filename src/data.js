export const library = [
  ...
  { id: "trio-sun-judicator", type: "monster", name: "曜冕裁决者", element: "light", stars: 7, atk: 3000, def: 1800, icon: "日", text: "需要 3 只我方场上怪兽作为祭品才能通常召唤。以三只祭品成功召唤时，手牌中其余不同名三曜神格会特殊召唤；它们本回合不能攻击。攻击结算后会破坏对手最靠前的魔陷区卡牌。", summary: "三祭品登场并引发三曜共降；共降怪兽下回合起进攻。", tributeCost: 3, rarity: "UR", archetype: "三曜神格", trioConvergence: "trioOmega", afterAttack: "sunflareSunder" },
