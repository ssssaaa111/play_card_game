export const library = [
  ...
  { id: "trio-sun-judicator", type: "monster", name: "曜冕裁决者", element: "light", stars: 7, atk: 3000, def: 1800, icon: "日", text: "需要 3 只我方场上怪兽作为祭品才能通常召唤。三曜神卡之一；攻击结算后会破坏对手最靠前的魔陷区卡牌。", summary: "三祭品登场的日曜神卡，攻击后继续破坏对手后场。", tributeCost: 3, rarity: "UR", archetype: "三曜神格", afterAttack: "sunflareSunder" },
  { id: "trio-moon-warden", type: "monster", name: "月蚀守密者", element: "light", stars: 6, atk: 2100, def: 2500, icon: "月", text: "需要 3 只我方场上怪兽作为祭品才能通常召唤。三曜神卡之一；配合月曜帷幕压低关键怪兽。", summary: "三祭品登场的月曜神卡，以高守备和持续压制封锁反击。", tributeCost: 3, rarity: "UR", archetype: "三曜神格" },
  { id: "trio-star-herald", type: "monster", name: "星坠宣告者", element: "light", stars: 6, atk: 2400, def: 1400, icon: "星", text: "需要 3 只我方场上怪兽作为祭品才能通常召唤。三曜神卡之一；攻击后追加 300 点终局压力，并提升自身攻击力 300。", summary: "三祭品登场的星曜神卡，攻击后持续累积终局伤害。", tributeCost: 3, rarity: "UR", archetype: "三曜神格", afterAttack: "starDoomCharge" },
